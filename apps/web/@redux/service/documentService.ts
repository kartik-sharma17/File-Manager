...
export const documentService = RootApiService.injectEndpoints({
    endpoints: (build) => ({
        createUploadRequest: build.mutation<ApiResponse<UploadRequestResponseData>,
        ...
        generateShareToken: build.mutation<ApiResponse<ShareTokenResponseData>,
        ...
        changeVisibility: build.mutation<ApiResponse<VisibilityResponseData>,
